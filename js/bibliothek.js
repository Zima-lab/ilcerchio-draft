...
function ZeitAnzeigen() { 
	            ...
	            var clock = Vorstd +Stunden +":" + Vormin +Minuten;
				
				setContent("id", "uhr", null, Gesamt);
				setContent("id", "datum_din5008", null, din5008);
				setContent("id", "dat_uhr", null, snow_zeit);
				setContent("id", "wt", null, wochentag);
				setContent("id", "uz", null, Uhrzeit );
	            setContent("id", "clock", null, clock );
